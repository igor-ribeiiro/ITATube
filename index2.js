...
function MarketMain() {
	...
	function openPopup() {
	TheNewWin=('<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "https:\/\/www.w3.org\/TR\/xhtml1\/DTD\/xhtml1-transitional.dtd"><html xmlns="https:\/\/www.w3.org\/1999\/xhtml">');
	...
	TheNewWin+=('<form name=ResourceBalanceForm action="https://www.extremetw.com/cgi-bin/ResourceBalancerv'+ version +'.py" method="post"><textarea name="input" rows="14" cols="60">'+msg+'</textarea></td></tr><tr><td>');
	...
	TheNewWin+=('<tr><td><h3><u>Upcoming</u> Advanced Features!</h3></td></tr><tr><td>We are currently working on a new optional advanced setting that will allow you to balance based upon coin/packet ratio, and on another feature that will let you access the resource balancing plan for one week via a unique url. Please post feedback and suggestions here: <a href="https://forum.tribalwars.net/showthread.php?t=172320" TARGET="_blank">https://forum.tribalwars.net/showthread.php?t=172320</a> <p><p>**Currently villages with more than 23950 farm population will have their resources balanced at 85% of your village average.  Villages with less than 22k farm population will begin to receive extra resources on a sliding scale depending on how empty the village farm is up to 200% of your village average.</td></td></table></td></tr></table>');
